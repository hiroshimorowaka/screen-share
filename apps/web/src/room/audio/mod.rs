...
#[cfg(not(feature = "hydrate"))]
#[allow(dead_code)]
pub(crate) fn set_shared_audio_muted(_conn: &crate::room::RoomSession, _muted: bool) {}

#[cfg(feature = "hydrate")]
pub(crate) fn set_shared_audio_muted(conn: &crate::room::RoomSession, muted: bool) {
    use wasm_bindgen::JsCast;
