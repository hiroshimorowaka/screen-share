...
pub(crate) fn setup_ping_loop(_conn: crate::room::RoomSession) {}

#[cfg(feature = "hydrate")]
fn send_ping(conn: &crate::room::RoomSession) {
...
#[cfg(feature = "hydrate")]
pub(crate) fn setup_ping_loop(conn: crate::room::RoomSession) {
