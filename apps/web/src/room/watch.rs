...
pub(super) fn stop_watching_click_handler(
    ...
    move |_| {
        ...
        crate::room::messages::teardown_link(
            &conn,
            &member.peer_id,
            crate::room::LinkDirection::Incoming,
        );
        if let Some(ws) = conn.ws.borrow().as_ref() {
...
pub(crate) fn leave_room(
    ...
    if was_sharing {
        ...
        crate::room::media::teardown_local_share(conn, me.as_deref());
    }
    ...
    crate::room::reconnect::teardown_session(conn);
