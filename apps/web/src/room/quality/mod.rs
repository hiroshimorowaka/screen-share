...
#[cfg(feature = "hydrate")]
pub(crate) fn is_auto_polling(conn: &crate::room::RoomSession, viewer_peer_id: &str) -> bool {
...
#[cfg(feature = "hydrate")]
pub(crate) fn stop_auto_polling(conn: &crate::room::RoomSession, viewer_peer_id: &str) {
    let Some(poll) = conn
...
/// graph alive.
#[cfg(feature = "hydrate")]
pub(crate) fn stop_all_auto_polling(conn: &crate::room::RoomSession) {
...
pub(crate) fn set_quality_handler(
    _conn: crate::room::RoomSession,
    _members: leptos::prelude::ReadSignal<Vec<crate::room::RoomMember>>,
...
pub(crate) fn set_quality_handler(
    conn: crate::room::RoomSession,
    members: leptos::prelude::ReadSignal<Vec<crate::room::RoomMember>>,
